...
public class ConcatPolyFunctionTests {
	...
	public void constructor_OnPassNotMatchingParts_ThrowsIllegalArgumentException() {
		...
		ConcatPart part1 = new ConcatPart(new PartialPolyFunction(first1, inner1, last1), ConcatPart.EManipulatable.FIXED, ConcatPart.EBalanceMode.IRRELEVANT);
		...
		ConcatPart part2 = new ConcatPart(new PartialPolyFunction(first2, inner2, last2), ConcatPart.EManipulatable.FIXED, ConcatPart.EBalanceMode.IRRELEVANT);
