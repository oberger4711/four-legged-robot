...
public class Vector2Test {
    ...
    @Test
    public void getLength_WithZeroVector2_ReturnsZero() {
        Vector2 testee = createVector2(0, 0);
        
        float length = testee.getLength();
        
        assertEquals(0, length, 0.0001f);
    }
    
    @Test
    public void getLength_WithBothDimensionsOneVector2_ReturnsSqrt2() {
        Vector2 testee = createVector2(1, 1);
        
        float length = testee.getLength();
        
        assertEquals(Math.sqrt(2), length, 0.0001f);
    }
