...
/**
 * Transparent decorator for {@link ExitCriterium} that ors the {@linkplain #isFinishState(com.oberger.kruppelbotsimulation.mvc_model.localsearch.State) } results.
 * @author ole
 */
