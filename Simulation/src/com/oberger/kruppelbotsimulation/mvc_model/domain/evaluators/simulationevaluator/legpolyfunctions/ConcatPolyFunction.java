 ...
 * @author oberger
 */
public class ConcatPolyFunction extends PolyFunction {

	private List<ConcatPart> parts = null;

	public ConcatPolyFunction(Interpolator interpolator, List<ConcatPart> parts) {
		super(interpolator, concatToList(parts));
