...
/**
 * {@link ExitCriterium} that returns true for {@linkplain #isFinishState(com.oberger.kruppelbotsimulation.mvc_model.localsearch.State)
 * } after the given timeout after {@linkplain #reset() } or initialization.
 *
 * @author ole
 */
