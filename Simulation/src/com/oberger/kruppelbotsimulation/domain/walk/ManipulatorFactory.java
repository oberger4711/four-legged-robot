...
import com.oberger.kruppelbotsimulation.domain.manipulators.PartialPolyFunctionManipulatorX;
...
public class ManipulatorFactory {
	...
	manipulators.add(new ConstrainedManipulator<>(new PartialPolyFunctionManipulatorX(settings.polygonManipulationStep), constraints));
	manipulators.add(new ConstrainedManipulator<>(new PartialPolyFunctionManipulatorX(-settings.polygonManipulationStep), constraints));
